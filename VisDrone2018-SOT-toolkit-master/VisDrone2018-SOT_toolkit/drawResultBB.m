...
fileName = strcat(datasetPath, 'sequences\',video_name,'\',id,'.','jpg');   
...
%             rectangle('Position', seq.ground_truth(i,:), 'EdgeColor', [1,0,0], 'LineWidth', LineWidth,'LineStyle',LineStyle);
%            rectangle('Position', resultsAll{j}.res(i,:), 'EdgeColor', plotDrawStyle{j+1}.color, 'LineWidth', LineWidth,'LineStyle',LineStyle);

%gt ºì  £» ourÂÌ£» autoÀ¶
%             text(6, 50, ['r:Ground-truth'],'Color','y', 'FontWeight','bold', 'FontSize',15);
%             text(5, 70, ['g:Our'],'Color','y', 'FontWeight','bold', 'FontSize',15);
%             text(5, 90, ['b:AutoTrack'],'Color','y', 'FontWeight','bold', 'FontSize',15);
           
           %            rectangle('Position', resultsAll{j}.res(i,:), 'EdgeColor', [0,0,1], 'LineWidth', LineWidth,'LineStyle',LineStyle);
